      ...
      <div className="container py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            <div className="relative w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-lg shadow-xl">
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white font-bold text-2xl">R</div>
            ...
            <div className="flex space-x-6">
              <a href="https://github.com/RUTUKAPATE" target="_blank" rel="noopener noreferrer" 
                className="text-gray-400 hover:text-primary transition-all transform hover:-translate-y-1">
                <i className="fab fa-github text-2xl"></i>
              </a>
              <a href="https://linkedin.com/in/rutuja-kapate" target="_blank" rel="noopener noreferrer" 
                className="text-gray-400 hover:text-primary transition-all transform hover:-translate-y-1">
                <i className="fab fa-linkedin text-2xl"></i>
              </a>
              <a href="https://x.com/KapateRutuja" target="_blank" rel="noopener noreferrer" 
                className="text-gray-400 hover:text-primary transition-all transform hover:-translate-y-1">
                <i className="fab fa-twitter text-2xl"></i>
              </a>
              <a href="mailto:rutuja16kapate@gmail.com" 
                className="text-gray-400 hover:text-primary transition-all transform hover:-translate-y-1">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              ...
              <Link to="/#education" className="text-gray-400 hover:text-primary transition-colors">Education</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              ...
              <Link to="/#services" className="text-gray-400 hover:text-primary transition-colors">Mobile Development</Link>
              <Link to="/#services" className="text-gray-400 hover:text-primary transition-colors">Consulting</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:rutuja16kapate@gmail.com" className="text-gray-400 hover:text-primary transition-colors">
        ...
        <div className="border-t border-gray-700/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {new Date().getFullYear()} Rutuja Kapate. All rights reserved.</p>
          <p className="text-gray-400 mt-4 md:mt-0">
            Made with <i className="fas fa-heart text-red-500 mx-1"></i> using modern technologies
          </p>
        </div>
      </div>
    </footer>
